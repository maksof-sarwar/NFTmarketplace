...
export const columns: ColumnDef<Def[number]>[] = [
	{
		...
		cell: ({ row }) =>
			row.original.collectionToken && (
				<div className="font-sans font-medium flex gap-6 items-center dark:text-white uppercase">
					...
					<div className="inline-flex justify-center items-center gap-1">
						<Link
							href={`/collection/${row.original.contractAddress}/${row.original.collectionToken.tokenId}`}
